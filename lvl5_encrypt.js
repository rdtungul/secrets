...
const userSchema = new mongoose.Schema({
  email: String,
  password: String,
  googleId: String //without googleId it adds multiple random/ encrypted id whenever you login to google.
});
...
// google authentication with google console dev apis
...
// this is an auth or access from users google profile
app.get("/auth/google",
